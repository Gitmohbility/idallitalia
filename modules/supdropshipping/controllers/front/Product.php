 ...
 */
class SupdropShippingProductModuleFrontController extends ModuleFrontController
{
    public function display()
    {
        ...
        $product = new \supdropshipping\Entity\SupProduct();
        $data = $product->{Tools::getValue('fc_action')}();
