...
class SupdropShippingOrderModuleFrontController extends ModuleFrontController
{
    public function display()
    {
        ...
        $orderService = new \supdropshipping\Entity\SupOrders();
        $action = Tools::getValue('fc_action');
        $return = $orderService->{$action}();
        $this->ajaxRender(
            $return
        );
        return false;
