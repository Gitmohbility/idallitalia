...
class SupdropShippingImageModuleFrontController extends ModuleFrontController
{
    public function display()
    {
        ...
        $image = new \supdropshipping\Entity\SupImage();
        $path = $image->{Tools::getValue('fc_action')}();
